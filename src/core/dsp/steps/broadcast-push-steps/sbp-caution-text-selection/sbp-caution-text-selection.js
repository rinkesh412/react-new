...
import "./sbp-caution-text-selection.styl";
...
export default class SBPCautionTextSelectionStep extends React.Component {
  // eslint-disable-line
  state = {
    cautionTextDataList: [],
    title: "",
  ...
  executeServiceOperationAdapter(jsoName, jsoParams) {
    ...
    /*  setTimeout(() => {
            ...
            let soResult = SBPCautionTextSelectionStep.getDerivedStateFromProps(this.props, this.state);
  ...
  static getDerivedStateFromProps(props, state) {
    // let newstate = {};
    console.log(
      "Inside getDerivedStateFromProps call back poll reponse",
    ...
    if (state.jsoCalled === "SO_SBP_GetMessageTemplate") {
      if (state.localDev) {
        ...
        if (props.getResults("SO_SBP_GetMessageTemplate")) {
          ...
          if (operationResult === "3" || operationResult === "2") {
            ...
            return { isJsoError: true, messageOnUI: state.message1 };
          }
        }
      }
      ...
      if (state.localDev) {
        ...
        console.log("get results of SO_SBP_SaveMessageTemplate");
...
SBPCautionTextSelectionStep.propTypes = {
