...
import './devices-admin-grid.container.styl';

export class DevicesAdminGrid extends Component {
    constructor(props) {
        super(props);
...
export default DevicesAdminGrid;

DevicesAdminGrid.propTypes = {
